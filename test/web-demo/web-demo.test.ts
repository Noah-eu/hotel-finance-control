...
describe('buildWebDemo', () => {
  ...
  it('shows a Czech text-layer invoice PDF as a recognized text PDF document without changing the known 16 / 2 payout result', async () => {
    ...
    expect(rendered.runtimeFileIntakeDiagnosticsContent.innerHTML).toContain('Raw block lines: Datum splatnosti │ Forma úhrady │ Datum vystavení │ Datum zdanitelného plnění | 25.03.2026 │ Přev.příkaz │ 11.03.2026 │ 11.03.2026 | 141260183 | Strana 1/1')
