...
function buildPayoutBatchDecisionSnapshot(
  ...
  return inspectPayoutBatchBankDecisions({
    ...
    return {
      ...
      crossMonthCarryoverCandidateExists: decision.crossMonthCarryoverCandidateExists,
      ...
      appliedComgateCrossMonthCarryoverRule: decision.appliedComgateCrossMonthCarryoverRule,
      wouldRejectOnStrictDateGate: decision.wouldRejectOnStrictDateGate,
      carryoverSourceMonth: decision.carryoverSourceMonth,
      carryoverBankMonth: decision.carryoverBankMonth,
      carryoverDayDelta: decision.carryoverDayDelta,
